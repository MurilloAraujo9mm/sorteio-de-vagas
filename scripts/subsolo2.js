...
// vagas vagasIndividuais sub-solo-2
const vagasIndividuais = [
    200, 201, 202, 404, 512, 988
];


// vagas vagasDuplas sub-solo-2
const vagasDuplas = [
...
function realizarSorteio(maxVagasDuplas = 15, maxVagasTriplas = 3, maxVagasIndividuais = 6) {
    ...
    mostrarContador(() => {
        ...
        const vagasRemanescentesIndividuaisList = document.getElementById("vagasRemanescentesIndividuais");
